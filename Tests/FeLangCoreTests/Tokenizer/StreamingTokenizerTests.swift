...
struct StreamingTokenizerTests {
    ...
    func testBufferTokenization() async throws {
        ...
        #expect(tokens.count > 0, "Should produce tokens from buffer")
    }
    ...
    func testStatePreservationAndResumption() async throws {
        ...
        #expect(tokens.count > 0, "Should resume tokenization from state")
    }
    ...
    func testChunkProcessor() {
        ...
        for i in 1..<chunks.count {
            let prevEnd = chunks[i-1].endOffset
            let currentStart = chunks[i].startOffset
    ...
    func testUnicodeHandlingInStreaming() async throws {
        ...
        #expect(tokens.count > 0, "Should handle Unicode characters")
