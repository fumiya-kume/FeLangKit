...
public struct BenchmarkFramework {
    ...
    public struct BenchmarkEnvironment: Codable {
        ...
        public init() {
            ...
            #if os(macOS)
            self.device = "Mac"
            self.os = "macOS \(processInfo.operatingSystemVersionString)"
            #elseif os(iOS)
            self.device = "iOS Device"
            self.os = "iOS \(processInfo.operatingSystemVersionString)"
            #else
            self.device = "Unknown"
            self.os = processInfo.operatingSystemVersionString
            #endif
